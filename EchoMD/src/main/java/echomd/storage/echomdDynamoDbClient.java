 ...
 */
public class echomdDynamoDbClient {
    private final AmazonDynamoDBClient dynamoDBClient;

    public echomdDynamoDbClient(final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public echomdUserDataItem loadItem(final echomdUserDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        echomdUserDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final echomdUserDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
